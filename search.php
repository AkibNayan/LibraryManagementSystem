        ...
        <div class="row shadow">
          <div class="col-lg-3">
            <ul class="category-section">
              <li><a href="index.php?#book-section" >All Books</a></li>
            </ul>
            <?php
          ...
          <div class="col-lg-9">
            ...
            <div class="allBooks" id="book-search">
              <div class="row">
                <?php
					...
					if (isset($_POST['searchBtn'])) {
						...
						$content = "SELECT * FROM book WHERE title LIKE '%$sContent%' OR sub_title LIKE '%$sContent%' OR description LIKE '%$sContent%' OR author_name LIKE '%$sContent%' ORDER BY title ASC ";
						$contentRes = mysqli_query($db, $content);
						$foundData = mysqli_num_rows($contentRes);
						if ($foundData <= 0) {
							echo "<span class='alert alert-info'>Opps!! No data found in our database related to your search topic - <b>$sContent</b></span>";
						}
						else {

							while ($row = mysqli_fetch_assoc($contentRes)) {
